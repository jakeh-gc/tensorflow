...
bool TypeSupport::SupportsOperand(const HloInstruction& hlo,
  ...
  switch (hlo.opcode()) {
    ...
    case HloOpcode::kConvert:
      ...
      return hlo.operand(0)->shape().element_type() == F8E5M2FNUZ;
    default:
      break;
  }
  return false;
...
bool TypeSupport::SupportsOutput(const HloInstruction& hlo) const {
  switch (hlo.opcode()) {
    case HloOpcode::kCall:
    case HloOpcode::kConditional:
    case HloOpcode::kCustomCall:
    ...
    case HloOpcode::kOptimizationBarrier:
      return true;
    case HloOpcode::kConvert:
      return hlo.shape().element_type() == F8E5M2FNUZ;
    default:
      break;
  }
  return false;
...
bool TypeSupport::SupportsMixedPrecisions(const HloInstruction& hlo) const {
  switch (hlo.opcode()) {
    case HloOpcode::kCall:
    case HloOpcode::kConditional:
    case HloOpcode::kConvert:
...
/* static */
bool TypeSupport::EffectiveOperandPrecisionIsOutputPrecision(
...
bool TypeSupport::EffectiveOperandPrecisionIsSourceType(
